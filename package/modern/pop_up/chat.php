...
<div class="container">
	...
	<div class="row">
					...
					<div class="form-group" id="msgError" style="margin-top:10px;">
						<div class="input-group">
							...
							<span class="input-group-btn">
						    	<button type="button" class="btn btn-dark" id="sendMessage"><i class="fa fa-paper-plane-o"></i></button>
						  	</span>
						</div>
					</div>
		...
		<div class="col-sm-4 sidebar">
			...
			<p><button name="sendMSG" id="sendMessage" class="btn btn-sm btn-block btn-dark"><i class="fa fa-paper-plane-o"></i> <?php echo $jkl["g11"];?></button></p>
