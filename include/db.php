...
define('JAKDB_PASS', 'hassan452'); // Database password ## Datenbank Passwort
...
// URL Rewrite
define('JAK_USE_APACHE', 1); // Use 1 for Apache / Nginx (SEO URL's) or 0 for all others
...
$jakhs = array();
// Only change things in here combination with Cloud Chat 3 (except copyright notice)
